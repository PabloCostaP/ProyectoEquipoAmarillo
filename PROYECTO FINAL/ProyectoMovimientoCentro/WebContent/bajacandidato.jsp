...
%>
	...
	<h3 style="text-align:center; margin-top: 2%; margin-bottom: 2%;">Baja Candidato</h3>
	<div class="container">
	<hr>
		<form action="operaciones.jsp?tipo=bajacandidato" method="post">
			...
			<br>
			<input type="submit" value="Dar de baja" id="boton" style="margin-top: 2.5%; padding:10px; background-color: #303F9F; color: white;">
		</form>
	</div>
	<script src="js/jquery.min.js"></script>
	<script src="js/dropdownbaja.js"></script>
</body>
</html>